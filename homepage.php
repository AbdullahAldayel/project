...
<select class="recom" name = "rating"> 

<option selected>Raiting</option>
<option value="4"> Only above 4 Stars</option>
<option value="3"> Only above 3 Stars</option>
<option value="0"> Any raiting</option>
...
<input class="btn btn-primary" type="submit" value="Recommend movies" style="margin-left:100px" >
...
<div class="recom1">
   ...
   <input class ="recom" type="text" name="addname" placeholder ="Movie's Title" >
  </div>

<select class="recom" name ="addgener">
<option selected>Choose gener</option>
<option value="Action">Action</option>
<option value="Comedy">Comedy</option>
<option value="Horror">Horror</option>
...
<select class="recom" name = "addrating"> 
...
<div class="form-group">
  ...
  <div class ="recom3">
  <input class="btn btn-primary" type="submit" value="Add Movie" style="margin-left:500px" >
  </div>
</form>
...
<div class="search-container">
    ...
    <form action="" method="post">
      <input class="recom" type="text" placeholder="Search.." name="title" > 
      <!-- <button type="submit">Submit<i class="fa fa-search"></i></button> -->
    ...
    <?php
        ...
        if(isset($_POST['search'])){
            ...
            $query = "SELECT * FROM movies WHERE title = '$title' AND status = '1'"; 
...
<option value="5"> 5</option>
   ...
   <!--<input type="text" placeholder = "You rating out of 5! " name =rate> -->

</select>
<input class="btn btn-primary1"  type="text" value= <?php if( $mid == null) {
            echo "id"; 
        }
        else 
          echo $mid;  ?> style="margin-left:1px" name ="movid">
<input class="btn btn-primary" type="submit" value="Rate now!" style="margin-left:1px" >
</form>
  </div>
</div>
