...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form id="resetform" role="form" method = "post" action='checkreset.php'>
    <?php
       // if(isset($_GET['error']))
    ...
    ?>
      ...
      <input type="password" id="opassword" class="fadeIn second" name="oldpwd" placeholder="Old password">

      <input type="password" id="npassword" class="fadeIn second" name="newpwd" placeholder="New password">
